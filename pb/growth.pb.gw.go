...
func RegisterUserCoinHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserCoinServer) error {
	...
	mux.Handle("GET", pattern_UserCoin_ListTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserCoin/ListTasks", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/ListTasks"))
		if err != nil {
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserCoin/UserCoinInfo", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/UserCoinInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserCoin_UserDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserCoin/UserDetails", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/UserDetails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinChange_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserCoin/UserCoinChange", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/UserCoinChange"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterUserGradeHandlerServer(ctx context.Context, mux *runtime.ServeMux, server UserGradeServer) error {
	...
	mux.Handle("GET", pattern_UserGrade_ListGrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserGrade/ListGrades", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/ListGrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_ListGradePrivileges_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserGrade/ListGradePrivileges", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/ListGradePrivileges"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_CheckUserPrivilege_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserGrade/CheckUserPrivilege", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/CheckUserPrivilege"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_UserGradeInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserGrade/UserGradeInfo", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/UserGradeInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_UserGradeChange_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/Grouth.UserGrade/UserGradeChange", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/UserGradeChange"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterUserCoinHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserCoinClient) error {
	...
	mux.Handle("GET", pattern_UserCoin_ListTasks_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserCoin/ListTasks", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/ListTasks"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserCoin/UserCoinInfo", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/UserCoinInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserCoin_UserDetails_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserCoin/UserDetails", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/UserDetails"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserCoin_UserCoinChange_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserCoin/UserCoinChange", runtime.WithHTTPPathPattern("/v1/Grouth.UserCoin/UserCoinChange"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UserCoin_ListTasks_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserCoin", "ListTasks"}, ""))

	pattern_UserCoin_UserCoinInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserCoin", "UserCoinInfo"}, ""))

	pattern_UserCoin_UserDetails_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserCoin", "UserDetails"}, ""))

	pattern_UserCoin_UserCoinChange_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserCoin", "UserCoinChange"}, ""))
)
...
func RegisterUserGradeHandlerClient(ctx context.Context, mux *runtime.ServeMux, client UserGradeClient) error {
	...
	mux.Handle("GET", pattern_UserGrade_ListGrades_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserGrade/ListGrades", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/ListGrades"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_ListGradePrivileges_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserGrade/ListGradePrivileges", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/ListGradePrivileges"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_CheckUserPrivilege_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserGrade/CheckUserPrivilege", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/CheckUserPrivilege"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_UserGradeInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserGrade/UserGradeInfo", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/UserGradeInfo"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_UserGrade_UserGradeChange_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/Grouth.UserGrade/UserGradeChange", runtime.WithHTTPPathPattern("/v1/Grouth.UserGrade/UserGradeChange"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_UserGrade_ListGrades_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserGrade", "ListGrades"}, ""))

	pattern_UserGrade_ListGradePrivileges_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserGrade", "ListGradePrivileges"}, ""))

	pattern_UserGrade_CheckUserPrivilege_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserGrade", "CheckUserPrivilege"}, ""))

	pattern_UserGrade_UserGradeInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserGrade", "UserGradeInfo"}, ""))

	pattern_UserGrade_UserGradeChange_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "Grouth.UserGrade", "UserGradeChange"}, ""))
)
